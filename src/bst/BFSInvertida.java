...
public class BFSInvertida {
	public static void main(String[] args) {
		Scanner sc = new Scanner(System.in);
		BFSInvertida bst = new BFSInvertida();
		String[] entrada = sc.nextLine().split(" ");
		for (String i : entrada) {
			bst.insert(Integer.parseInt(i));
		}
		System.out.println(bst.buscaProf());
		sc.close();
	}
	...
	class Node {
		...
		private BFSInvertida getOuterType() {
			return BFSInvertida.this;
		}
