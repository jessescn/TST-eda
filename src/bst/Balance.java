...
public class Balance {
	public static void main(String[] args) {
		...
		System.out.println(b.listOfBalance());
	...
	public String listOfBalance() {
		String result = "";
		ArrayList<Integer> array = this.preOrder();
		for(Integer n: array) {
			result += n + "," + balance(search(n)) + " ";
		}
		return result.trim();
	}
